            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-3xl mx-auto text-center mb-16">
                    ...
                    <p className="text-gray-600 text-lg">
                        Oferecemos opções que se adaptam às suas necessidades,
                        com recursos exclusivos e a possibilidade de contribuir
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    <div className="border border-divine-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow animate-slide-in-left">
                        <div className="bg-divine-100 p-6">
                            ...
                            <div className="mt-4 flex items-end">
                                <span className="text-4xl font-bold text-divine-700">
                                    R$19,90
                                </span>
                                <span className="text-gray-600 ml-2">/mês</span>
                            </div>
                            <p className="mt-2 text-gray-600 text-sm">
                                Mensagens diárias inspiradoras com configurações
                                essenciais.
                            </p>
                        </div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span className="text-gray-600">
                                        1 mensagem diária via WhatsApp
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Check className="h-5 w-5 text-divine-500 mt-0.5" />
                                    <span className="text-gray-600">
                                        Escolha entre 3 horários de envio
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Check className="h-5 w-5 text-divine-500 mt-0.5" />
                                    <span className="text-gray-600">
                                        2 vozes de narração disponíveis
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Check className="h-5 w-5 text-divine-500 mt-0.5" />
                                    <span className="text-gray-600">
                                        Biblioteca com mensagens anteriores
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Check className="h-5 w-5 text-divine-500 mt-0.5" />
                                    <span className="text-gray-600">
                                        20% da assinatura para caridade
                                    </span>
                                </li>
                            </ul>

                            <Button
                                onClick={() => onGetStartedClick("basic")}
                                className="w-full mt-6 bg-divine-500 hover:bg-divine-600 text-white"
                            >
                                Começar com Básico
                            </Button>
                        </div>
                    ...
                    <div className="border-2 border-divine-500 rounded-2xl overflow-hidden shadow-lg relative animate-slide-in-right">
                        <Badge className="absolute top-4 right-4 bg-divine-500 text-white">
                            Recomendado
                        </Badge>
                        ...
                        <div className="bg-divine-500/10 p-6">
                            ...
                            <p className="mt-2 text-gray-600 text-sm">
                                Experiência completa com personalização avançada
                        ...
                        <div className="p-6">
                            <ul className="space-y-4">
                                <li className="flex items-start gap-3">
                                    <Check className="h-5 w-5 text-divine-500 mt-0.5" />
                                    <span className="text-gray-600">
                                        Até 3 mensagens diárias
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Check className="h-5 w-5 text-divine-500 mt-0.5" />
                                    <span className="text-gray-600">
                                        Personalização completa de horários
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Check className="h-5 w-5 text-divine-500 mt-0.5" />
                                    <span className="text-gray-600">
                                        8 vozes de narração disponíveis
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Check className="h-5 w-5 text-divine-500 mt-0.5" />
                                    <span className="text-gray-600">
                                        Músicas de fundo personalizáveis
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Check className="h-5 w-5 text-divine-500 mt-0.5" />
                                    <span className="text-gray-600">
                                        Biblioteca exclusiva de conteúdo
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Check className="h-5 w-5 text-divine-500 mt-0.5" />
                                    <span className="text-gray-600">
                                        Escolha dos temas de mensagens
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <Check className="h-5 w-5 text-divine-500 mt-0.5" />
                                    <span className="text-gray-600">
                                        40% da assinatura para caridade
                                    </span>
                                </li>
                            </ul>

                            <Button
                                onClick={() => onGetStartedClick("premium")}
                                className="w-full mt-6 bg-divine-500 hover:bg-divine-600 text-white"
                            >
                                Começar com Premium
                            </Button>
                ...
                <div className="max-w-3xl mx-auto mt-12 bg-divine-100 rounded-xl p-6 text-center">
                    ...
                    <p className="text-gray-600">
                        Uma porcentagem de cada assinatura é destinada a
                        projetos sociais e obras de caridade. Juntos, podemos
                        fazer a diferença enquanto nutrimos nossa fé.
                    </p>
                </div>
            </div>
        </section>
